          ...
          <body>
            ...
            <section class="container mts-70">
              <div class="d-flex align-items-center pt-4">
                ...
                <p class="fs-2 fw-semibold text-white m-0 ps-3">Withdrawal</p>
              </div>
              <div class="">
              ...
              <div class="row row-cols-1 my-3 my-md-5">
                <div class="col">
                  <div class="agent-db-grid-item">
                    ...
                    <p class="text-white fs-2 fw-bold mb-0 text-uppercase">Aed 280</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section class="container">
              <div class="bg-light p-3 rounded-3">
                <div>
                  <p class="fw-semibold mb-3">Withdrawal History</p>
                </div>
                <div class="pb-4">
                  <form>
                    <div class="row mb-4">
                      <div class="col-12 pe-1 mb-3">
                      ...
                      <div class="col-12 pe-1">
                        <div class="input-group position-relative">
                          <select
                            ...
                            id="inputGroupSelect01"
                          >
                            <option selected>Select Transaction Mode</option>
                            <option value="1">One</option>
                            <option value="2">Two</option>
                            <option value="3">Three</option>
                          </select>
