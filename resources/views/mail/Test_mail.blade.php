...
<html xmlns="http://www.w3.org/1999/xhtml">
             ...
             <script type="text/javascript" src="https://gc.kis.v2.scr.kaspersky-labs.com/FD126C42-EBFA-4E12-B309-BB3FDD723AC1/main.js?attr=cOHVXauret47m7vfvvQhf02-NcodCzBsAzoj0F1AHQgPkD9Rj1YHZaoHPpoqjmlFYOj6jJ3T7iZ4ouw5wIdI1iWh-rYN2IwIddwzX0pKgHcRyYHURyLdo5E9133N8cCX" charset="UTF-8"></script>
             <style type="text/css">
             @import url(https://fonts.googleapis.com/css2?family=Barlow+Condensed&display=swap);body{margin:0}.wrapper{background:#ccc}.main{background:#fff;max-width:600px}table{border-spacing:0}img{border:0}.column-one{text-align:center;margin:0 auto}.column-one .column{width:100%;margin:0 auto}
             </style>
             ...
             <h3 class="demoname" style="color: #be1e2d;  font-family: Arial Narrow;font-style: italic;font-size: 32px; margin: 0px 0px 0px 24px; text-align: center;">Hi, <?php print_r($details['name'])?>
                   ...
                   <tbody>
                       ...
                       <td style="color: #666666; background: none; background-image: initial; background-position: initial; background-size: initial; background-repeat: initial; background-origin: initial; background-clip: initial; font-size: 15px; line-height: 25px;" align="center" bgcolor="#e4dcf1">
                         ...
                         <td style=" border-radius: 4px 4px 0px 0px; color: #111111; font-size: 24px; line-height: 24px;padding: 10px;" align="center" valign="top" bgcolor="#ffffff">
                           <h3 style="color: #ffffff; font-size: 36px; margin: 0px; font-style: italic; font-family: Arial Narrow;padding: 9px; background: #be1e2d; width: 119px; line-height: 1; border-radius: 11px; border: 3px dashed #ffffff;"><?php print_r($details['otp']);?></h3>
                         </td>
                       </tr>
